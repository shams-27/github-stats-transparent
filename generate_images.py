...
async def generate_languages(s: Stats) -> None:
    ...
    for i, (lang, data) in enumerate(sorted_languages):
        ...
        lang_list += f"""\
  <div class="lang-item" style="display: flex; align-items: center; gap: 7px; flex: 1; white-space: nowrap; font-size: 11px;">
    <svg xmlns="http://www.w3.org/2000/svg" class="octicon" style="fill:{color}; opacity: 0.9; flex-shrink: 0;"
      viewBox="0 0 16 16" version="1.1" width="12" height="12">
